    ...
    public class OfferBusiness
    {
        ...
        public async Task<ResponseMessage<string>> Create(Offer offer, IFormFile image, Guid userID)
        {
            ...
            try
            {
                ...
                if (await _unitOfWork.Commit() > 0)
                {
                    ...
                    responseMessage.Message = "Offer Added";
                }
                else
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Offer Not Added";
                }
            }
            catch (Exception)
            {
        ...
        public async Task<ResponseMessage<string>> Delete(Guid offerID)
        {
            ...
            try
            {
                ...
                if (item != null)
                {
                    ...
                    responseMessage.Message = "Offer Hidden";
                }
                else
                {
                    _unitOfWork.Offers.Delete(offer);
                    responseMessage.Message = "Offer Deleted";
                }
                ...
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Offer Not Deleted";
                }
            }
            catch (Exception)
            {
        ...
        public async Task<ResponseMessage<string>> ToggleHome(Guid offerID)
        {
            ...
            try
            {
                ...
                {
                    responseMessage.StatusCode = 200;
                    responseMessage.Message = "Offer Modified";
                }
                else
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Offer Not Modified";
                }
            }
            catch (Exception)
            {
