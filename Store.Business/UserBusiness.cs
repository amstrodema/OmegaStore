    ...
    public class UserBusiness
    {
        ...
        public async Task<ResponseMessage<User>> Login(string usernameOrPasswordorPhone, string password)
        {
            ...
            try
            {
                ...
                User thisUser = await _unitOfWork.Users.GetUserByUserNameOrEmail(usernameOrPasswordorPhone, _genericBusiness.StoreID);
                ...
                else if (EncryptionService.Validate(password, thisUser.Password))
                {
                    ...
                    {
                        responseMessage.StatusCode = 200;
                        responseMessage.Data = thisUser;
                        responseMessage.Message = "Login Successful!";
                    }
                    else
                    {
                        responseMessage.StatusCode = 201;
                        responseMessage.Message = "Login Not Successful!";
                    }
                }
                else
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Invalid login details!";
                }
            }
            catch (Exception e)
            {
        ...
        public async Task<ResponseMessage<User>> Create(User user)
        {
            ...
            try
            {
                ...
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "User exist already";
                    return responseMessage;
                }
                ...
                {
                    responseMessage.StatusCode = 200;
                    responseMessage.Message = "Registration Completed!";
                }
                else
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Registration Not Completed!";
                }
            }
            catch (Exception e)
            {
        ...
        public async Task<ResponseMessage<string>> ChangePassword(Guid userID, string verCode, string newPassword)
        {
            ...
            try
            {
                if (thisUser.PasswordVer != verCode)
                {
                    responseMessage.StatusCode = 209;
                    responseMessage.Message = "Invalid code!";
                    return responseMessage;
                }
                else if (thisUser.PasswordVerExp < DateTime.UtcNow.AddHours(1))
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Password verification code expired!";
                    return responseMessage;
                }
                ...
                {
                    responseMessage.StatusCode = 200;
                    responseMessage.Message = "Paasword modified!";
                    return responseMessage;
                }
            }
            catch (Exception e)
            {
                responseMessage.StatusCode = 201;
                responseMessage.Message = "Password not modified!";
                FileService.WriteToFile("\n\n" + e, "ErrorLogs");
            }
        ...
        public async Task<ResponseMessage<string>> ResetPassword(Guid userID, string email)
        {
            ...
            {
                thisUser = await _unitOfWork.Users.GetUserByUserNameOrEmail(email, _genericBusiness.StoreID);
            }
            ...
            try
            {
                ...
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Password verification not sent!";
                    return responseMessage;
                }
                ...
                responseMessage.Data = thisUser.ID.ToString();
                ...
                if (await _unitOfWork.Commit() > 0)
                {
                    ...
                    responseMessage.StatusCode = 200;
                    responseMessage.Message = "Password verification sent!";
                    return responseMessage;
                }
            }
            catch (Exception e)
        ...
        public async Task<ResponseMessage<string>> ResetEmailVerification(Guid userID)
        {
            ...
            {
                responseMessage.StatusCode = 201;
                responseMessage.Message = "Email verification not sent!";
                FileService.WriteToFile("\n\n" + e, "ErrorLogs");
            }
        ...
        public async Task<ResponseMessage<string>> EmailVerification(Guid userID, string verCode)
        {
            ...
            try
            {
                ...
                {
                    responseMessage.StatusCode = 201;
                    responseMessage.Message = "Email verification code expired!";
                    return responseMessage;
                }
                ...
                {
                    responseMessage.StatusCode = 200;
                    responseMessage.Message = "Email verified!";
                    return responseMessage;
                }
            }
            catch (Exception e)
        ...
        public async Task<ResponseMessage<int>> LogOut(Guid userID, Guid appID)
        {
            ...
            try
            {
                LoginMonitor loginMonitor = await _unitOfWork.LoginMonitors.GetMonitorByUserID(userID, appID, _genericBusiness.StoreID);
